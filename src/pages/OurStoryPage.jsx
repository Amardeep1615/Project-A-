    ...
    <div className="bg-gradient-to-b from-indigo-50 to-white font-poppins text-gray-800">
      ...
      <section className="py-20 text-center">
        <div className="max-w-2xl mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-amber-500 mb-4 relative">
            Our Story
            <span className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-20 h-1 bg-black rounded"></span>
          </h1>
          <p className="text-gray-700 mt-4 leading-relaxed">
            The journey of <strong className="text-black">ANA Innovative Works</strong> —
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 space-y-16">
          {[
            ...
            >
              <div className="flex-shrink-0 w-24 h-24 md:w-32 md:h-32 bg-amber-500 text-black rounded-full flex items-center justify-center text-xl md:text-2xl font-bold shadow-lg animate-fadeIn">
                {item.year}
              </div>
              <div className="bg-white border border-gray-100 shadow-md p-6 rounded-xl w-full md:w-1/2 transition-transform transform hover:-translate-y-1 hover:shadow-xl">
                <h3 className="text-xl md:text-2xl font-semibold text-black mb-2 relative">
                  {item.title}
                  <span className="absolute -bottom-1 left-0 w-12 h-1 bg-amber-500 rounded"></span>
                </h3>
      ...
      <section className="py-20 bg-gradient-to-b from-indigo-50 to-white text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-black mb-12 relative inline-block">
          Our Mission & Vision
          <span className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-20 h-1 bg-amber-500 rounded"></span>
        </h2>
        <div className="flex flex-col md:flex-row justify-center gap-8 max-w-4xl mx-auto px-4">
          <div className="bg-white shadow-lg p-8 rounded-xl flex-1 border border-gray-100">
            <h3 className="text-xl font-bold text-amber-500 mb-4">Mission</h3>
          ...
          <div className="bg-white shadow-lg p-8 rounded-xl flex-1 border border-gray-100">
            <h3 className="text-xl font-bold text-amber-500 mb-4">Vision</h3>
            <p className="text-gray-600">
